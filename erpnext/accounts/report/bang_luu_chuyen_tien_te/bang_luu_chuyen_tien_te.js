...
// frappe.require("assets/erpnext/js/luu_chuyen_tien_te.js", function() {
// 	frappe.query_reports["Bang Luu Chuyen Tien Te"] = $.extend({},
// 		erpnext.luu_chuyen_tien_te);

// 	erpnext.utils.add_dimensions('Bang Luu Chuyen Tien Te', 10);

// });

frappe.query_reports["Bang Luu Chuyen Tien Te"] = {
	...
	"formatter": function(value, row, column, data, default_formatter) {
		...
		if (data.ma_so==null || data.ma_so=='20'
		|| data.ma_so=='30' || data.ma_so=='40'
		|| data.ma_so=='50' || data.ma_so=='70')
			{
