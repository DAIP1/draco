...
// 	frappe.query_reports["Scripts Report Bang Can Doi Ke Toan"] = $.extend({}, erpnext.filterCanDoi);
...
erpnext.CDKT={
	"open_general_ledger": function(data) {
		...
		frappe.set_route("query-report", "Chi Tiet Test");
	}
};
frappe.query_reports["Scripts Report Bang Can Doi Ke Toan"] = {

	"filters": get_filters(),
	"formatter": function(value, row, column, data, default_formatter) {

		column.link_onclick =
			"erpnext.CDKT.open_general_ledger(" + JSON.stringify(data) + ")";
		column.is_tree = true;

		

		value = default_formatter(value, row, column, data);
		list=[100,110,120,130,140,150,200,210,220,230,240,250,260,270,300,310,330,400,410,430,440]
